% This code generates the pre-trained DNNs using only the data from
% training participants. Then those pre-trained networks are adapted to
% the test participant in the "main.m". For deatils please look [1].
...
for test_participant=1:totalparticipants
    ...
    sv_name=['main_net_',dataset,'_',num2str(signal_length),'_',int2str(test_participant),'.mat']; 
